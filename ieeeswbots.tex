...
However, developers need to consider where to host bots, how to create them, but also when not to use bots. \cp{I think there's a big hole between the previous paragraphs and this one...it doesn't flow.}

\section{Bot-ology: Understanding the Bot Landscape}
% [Peggy]
...
Rather than attempting to narrowly define bots or chatbots, instead we look at ways of characterizing them. 
...
interacting with end users (at scale) to answer frequently asked questions and to analyze user feedback (ZenDesk's AnswerBot\footnote{https://www.zendesk.com/answer-bot/}).
%\end{itemize}
